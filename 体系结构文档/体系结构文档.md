...
|                             接口                             | 服务调用方       | 服务提供方       |
| :----------------------------------------------------------: | ---------------- | ---------------- |
| PromotionService<br />UserService<br />TicketService<br />HallService<br />CouponService<br /> | 客户端展示层     | 客户端业务逻辑层 |
